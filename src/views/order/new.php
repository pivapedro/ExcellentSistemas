    ...
    <div class="row">
      ...
      <div class="col my-5">
        ...
        <form>
          ...
          <div class="form-group row my-2" id='images'>
...
<script type='module'>
  ...
  const deleteImage = (id) => {
    try {
      const {
        data
      } = axios.delete('http://localhost:8080/api/product/image', {
        image_id: id
      })
  ...
  $(document).ready(async function() {
    ...
    if (productId) {
      ...
      const imagens = data.imagens.map(image =>
        `<div class='col-2 text-center'>
        <img  class='' src='data:image/png;base64,${image.image_src}' width=100 /> 
       </div>`)
      $("#images").html(imagens.map(image => image))
